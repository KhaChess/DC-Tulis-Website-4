...
const Dashboard = () => {
  ...
  const pauseSession = () => {
    ...
    toast({
      ...
      description: "Auto-typer has been paused.",
    });
  };
  ...
  // Don't render until initialized to prevent ResizeObserver errors
  if (!isInitialized) {
    return (
              ...
              <CardContent className="space-y-6">
                <Tabs defaultValue="messages" className="w-full">
                  <TabsList className="grid w-full grid-cols-3 bg-slate-700">
                    <TabsTrigger value="messages" className="text-white data-[state=active]:bg-slate-600">Messages</TabsTrigger>
                    <TabsTrigger value="settings" className="text-white data-[state=active]:bg-slate-600">Timing</TabsTrigger>
                    <TabsTrigger value="discord" className="text-white data-[state=active]:bg-slate-600">Discord</TabsTrigger>
                  </TabsList>
                  ...
                  <TabsContent value="settings" className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label className="text-white">Random Delay (±50%)</Label>
                    </div>
                  </TabsContent>
          ...
          <div className="space-y-6">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">
                  Start, pause, or stop your session
                </CardDescription>
              </CardHeader>
